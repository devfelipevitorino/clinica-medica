    ...
    <div class="w-64 h-screen bg-white border-r flex flex-col justify-between">
        ...
        <div>
            <div class="flex items-center gap-3 p-6 border-b">
                ...
                <div>
                    <p class="font-semibold text-gray-900">MedPrime</p>
                    <p class="text-sm text-gray-500 -mt-1">Sistema de Gestão</p>
                </div>
            </div>
            ...
            <nav class="mt-6 space-y-1 px-4">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-2 rounded-lg bg-blue-50 text-blue-600 transition">
                ...
                {{-- Pacientes --}}
                <a href="#" class="flex items-center gap-3 px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
